...
def load_chain():
    ...
    # 向量数据库持久化路径
    persist_directory = '/root/workout_assistant_2/script/data_base_workout_assistant/vector_db/chroma'
    ...
    #直接调用internlm2-chat-7b
    llm = InternLM_LLM(model_path = "/root/data/model/internlm2-chat-7b")
    #调用xtuner微调后的model
    # llm = InternLM_LLM(model_path = "/root/workout_assistant/config/work_dirs/hf_merge")
...
with block as demo:
    ...
    gr.Markdown("""提醒：<br>
        1. 本助手是利用 InternLM2-chat-7B 模型和 Langchain 搭建的“健身小助手”。
